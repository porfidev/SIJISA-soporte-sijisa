...
<table width="90%" id="<?php echo $idtabla ?>">
	<tr>
	      	<th>Fecha</th>
	      	<th>Remitente</th>
...
while($registro=mysql_fetch_array($datos)) 
{
	...
	?>
	    <tr>
	      	<td align="left" valign="middle" class="fecha_articulointerior">
			Fecha de alta: <?php echo $fecha_alta ?><br>
			Remitente: <?php echo $remitente ?><br>
			Destinatario: <?php echo $destinatario ?><br>
			Problema: <?php echo $problema ?><br>
			Observaciones: <?php echo $observaciones ?><br>
		</td>
