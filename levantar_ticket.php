...
<td colspan="3" style="padding:20px 0px 20px 0px">
		...
		<?php
		//-- Combo Empresas
		$datos = mysql_query("SELECT * FROM catEmpresas") or die(mysql_error());		
		if (mysql_num_rows($datos)==0){} else {
...
<?php } else {echo $_SESSION['message_auth'];} ?> <br><br> <?php
