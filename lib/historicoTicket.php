    ...
    if(!empty($tickets)) {
        ...
        foreach ($tickets as $indice => $campo) {
            ...
            if($campo['archivos'] != null or $campo['archivos'] != '') {
                ...
                if($archivos[0] != '') {
                    $valores .= "<a href=\"" . $rutafinal . "/" . $archivos[0] . "\" target='_blank'>Archivo 1</a><br>";
                }
                if($archivos[1] != '') {
                    $valores .= "<a href=\"" . $rutafinal . "/" . $archivos[1] . "\" target='_blank'>Archivo 2</a><br>";
                }
                if($archivos[2] != '') {
                    $valores .= "<a href=\"" . $rutafinal . "/" . $archivos[2] . "\" target='_blank'>Archivo 3</a><br>";
                }
            }
        ...
        $respuesta = array("tickets" => false, "estatus" => "que pasa!");
        echo json_encode($respuesta);
    }
}
