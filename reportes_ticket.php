...
while($registro=mysql_fetch_array($datos)) 
{
	...
	?>
	    ...
	    <?php $contador++; } if ($_SESSION['intIdTipoUsuario']==1) {?>
	<tr><td colspan="6" style="text-align:right"><a href="javascript:abrirpopup('view.php?s=<?php echo $estatus; ?>',1024,500)">Ver reporte</a></td></tr> <?php } ?>
      </table>
