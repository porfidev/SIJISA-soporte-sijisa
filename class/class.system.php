...
class Sistema{
    ...
    public function restablecerCorreo($mail, $nameUser, $idUser){
        ...
        $this->valores = array("fecha_solicitud" => $this->getDateTime(strtotime("now")),
    ...
    public function borrarToken($token){
        ...
        $this->valores = array("token" => $token);
    ...
    private function generaToken($cadena){
        Urlcrypt::$key = "54763051cef08bcd417e2ffb2a001cef08bcd417e2ef08bcd417e2ffb2aef08b";
